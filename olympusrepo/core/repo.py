...
# ---------------------------------------------------------------------------
# Git import — single-commit ingestion
# ---------------------------------------------------------------------------
# Used by olympusrepo/core/import_git.py. Caller wraps the whole import
# loop in one transaction so a mid-import failure rolls back cleanly.
# Depends on sql/015_git_import.sql:
#   * repo_insert_imported_commit() function
#   * is_imported / *_email columns on repo_commits
    ...
    with conn.cursor() as cur:
        ...
        cur.execute(
            ...
            """,
            {
                ...
                "author_tz":       author_tz_offset,
                "committer_name":  committer_name,
                "committer_email": committer_email,
                "committed_at":    committed_at,
                "committer_tz":    committer_tz_offset,
                "message":         message,
            },
        )
        rev = cur.fetchone()[0]
